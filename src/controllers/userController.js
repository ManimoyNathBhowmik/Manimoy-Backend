...
const createUser = async function (req, res) {
    ...
    } catch (err) { return res.status(100).send({ msg: "Server Error" }) }
};
...
const loginUser = async function (req, res, next) {
    ...
    } catch (err) { return res.status(401).send({ msg: "Server Error" }) }
}
...
const getUserData = async function (req, res) {
    ...
    } catch (err) { return res.status(400).send({ msg: "Server Error" }) }
...
const updateUser = async function (req, res) {
    ...
    } catch (err) { return res.status(500).send({ msg: "Server Error" }) }
};
...
const deleteUser = async function (req, res) {
    ...
    } catch (err) { return res.status(404).send({ msg: "Server Error" }) }
